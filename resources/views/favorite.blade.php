...
<head>
    ...
    <!-- Link -->
    <link rel="shortcut icon" type="image/favicon.ico" href="/favicon.png">
    ...
    <title>FAVORITE | {{ config('app.name') }}</title>
...
<body data-barba="wrapper">
        ...
        <section class="flexTop">
            <section class="home-section">
                <div class="home-content">
                    <svg class='bx bx-menu-alt-left' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M4 11h12v2H4zm0-5h16v2H4zm0 12h7.235v-2H4z"></path></svg>
    ...
    <div class="sidebar close">
        ...
        <ul class="nav-links">
            <div class="nav-over">
                ...
                <li>
                    <div class="icon-link">
                        <a href="/intern/musicdistributionsite/public/favorite">
            ...
            <li id="profile">
                <div class="profile-details">
                    ...
                    <div class="profile-content">
                        <a href="{{ asset(Auth::user()->id) }}"><img src="storage/user_primary_img/{{ Auth::user()->primary_img }}" alt="profileImg"></a>
                    </div>
                    <div class="name-job">
    ...
    <main id="top" data-barba="container" data-barba-namespace="favorite">
        <div id="middleArea">
            <div class="blueBg"></div>
            <div class="whiteBlur"></div>
            <div class="swiper-wrapper dismiss"></div>
            ...
            <!-- <section id="dashboard">
                <div class="dashboardImg">
                    <img src="storage/user_primary_img/{{ Auth::user()->primary_img }}" alt="profileImg">
                </div>
                    ...
                    <li class="">
                        <div>
                            <div href="#" class="albumListImg">
                                ...
                                <button class="start" type="button" songName="{{$album->getAlbumName()}}" userName="{{$album->getUserName()}}" imgName="{{ asset('storage/albums/'.$album->getAlbumImg()) }}" value="{{$album->getFileName()}}.{{$album->getFileExt()}}">
                                    <div id="buttonV" class="buttonV"><svg xmlns="http://www.w3.org/2000/svg" width="1.8rem" height="1.8rem" viewBox="0 0 24 24" style="fill: white;"><path d="M7 6v12l10-6z"></path></svg></div>
                                </button>
                            </div>
                            <div class="albumListContent">
                                <div class="albumLeft">
                                    <p class="albumName"><a href="./album/{{$albumId}}">{{$album->getAlbumName()}}</a></p>
                                    <p class="artistName"><a href="#">{{$album->getUserName()}}</a></p>
                                </div>
                                @auth
