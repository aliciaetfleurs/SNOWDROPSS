...
<body data-barba="wrapper">
    ...
    <div class="sidebar close">
        ...
        <ul class="nav-links">
            <div class="nav-over">
                ...
                <li>
                    <div class="icon-link">
                        <a href="/intern/musicdistributionsite/public/">
            ...
            <li id="profile">
                <div class="profile-details">
                    ...
                    <div class="profile-content">
                        <a href="{{ asset('user/'. Auth::user()->id )}}"><img src="{{ asset('storage/user_primary_img/'.Auth::user()->primary_img)}}" alt="profileImg"></a>
                    </div>
                    <div class="name-job">
    ...
    <main id="top" data-barba="container" data-barba-namespace="top">
        <div id="uploadArea">
            <form action="{{ route('upload')}}" method="post" id="upload">
                <label for="addAlbumName">
                    <p>アルバム名</p>
                    <input type="number" id="addAlbumName" name="addAlbumName" value="" required>
                </label>
                <label for="addAlbumComposer">
                    <p>作曲者</p>
                    <input type="number" id="addAlbumComposer" name="addAlbumComposer" value="" required>
                </label>
                <label for="addAlbumExplicit">
                    <p>不適切な内容の音楽</p>
                    <input type="number" id="addAlbumExplicit" name="addAlbumExplicit" value="" required>
                </label>
                <label for="addAlbumArt">
                    <p>アルバムアート</p>
                    <input type="number" id="addAlbumArt" name="addAlbumArt" value="" required>
                </label>
                <label for="addAlbumType">
                    <p>タイプ</p>
                    <select type="number" id="addAlbumType" name="addAlbumType" value="" required>
