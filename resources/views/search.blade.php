...
<body data-barba="wrapper">
    ...
    <div class="sidebar close">
        ...
        <ul class="nav-links">
            <div class="nav-over">
                <li class="nav-search">
                    <form action="{{ route('search') }}" method="get" class="icon-link" id="search">
                        <button type="submit"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M10 18a7.952 7.952 0 0 0 4.897-1.688l4.396 4.396 1.414-1.414-4.396-4.396A7.952 7.952 0 0 0 18 10c0-4.411-3.589-8-8-8s-8 3.589-8 8 3.589 8 8 8zm0-14c3.309 0 6 2.691 6 6s-2.691 6-6 6-6-2.691-6-6 2.691-6 6-6z"></path><path d="M11.412 8.586c.379.38.588.882.588 1.414h2a3.977 3.977 0 0 0-1.174-2.828c-1.514-1.512-4.139-1.512-5.652 0l1.412 1.416c.76-.758 2.07-.756 2.826-.002z"></path></svg></button>
                        @csrf    
                        <input type="text" class="search" name="searchText" value="" placeholder="SEARCH">
                    </form>
                </li>
                <li>
                    <div class="icon-link">
            ...
            <li id="profile">
                <div class="profile-details">
                    ...
                    <div class="profile-content">
                        <a href="#"><img src="storage/user_primary_img/{{ Auth::user()->primary_img }}" alt="profileImg"></a>
                    </div>
                    <div class="name-job">
    ...
    <main id="top" data-barba="container" data-barba-namespace="serach">
        <div id="middleArea">
            <div class="searchResult">
                <p class="searchHead">検索結果 | </p> 
                <p id="searchStr"></p> 
            </div>
